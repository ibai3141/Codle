...
export default function Logo() {
	...
	// Mensaje de error si algo sale mal (fallo de red, datos incompletos, etc).
		...
		function () {
			async function inicializarPartida() {
				try {
					...
					const intentosNormalizados = (partidaActiva.intentos ?? []).map(normalizarIntentoLogo);
	...
	async function procesarIntento(respuesta) {
		...
		try {
            ...
            // Si ya existe un intento con el mismo numeroIntento, no lo añadimos (se evitan duplicados accidentales)
	...
	return (
		<section className="classic-page">
			...
			{/* Historial básico de intentos (sin visual de imagen, por ahora) */}
